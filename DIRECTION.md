...
Sources: nine interviews in July 2026 ([#4](https://github.com/alp82/aistack/issues/4), [transcripts](docs/research/user-interviews-2026-07/findings.md)), two live sync tests ([#68](https://github.com/alp82/aistack/issues/68), [#69](https://github.com/alp82/aistack/issues/69)), three direct reports ([#1](https://github.com/alp82/aistack/issues/1), [#50](https://github.com/alp82/aistack/issues/50), and the six-point stack page and login report fixed on [map #292](https://github.com/alp82/aistack/issues/292)), and prod behavior. The 2026-08-17 broadcast to 177 addresses was read in [#161](https://github.com/alp82/aistack/issues/161): it drove one day of traffic, it moved no signup baseline, and it cost no unsubscribes.
...
- **A stack owner on 2026-08-27** ([map #292](https://github.com/alp82/aistack/issues/292)): six stack page and login issues, from an extra harness in the measured rows to the accent missing in popovers. All six shipped within a day. The report exposed duplicate model rows in the catalog; the picker can still create them.
...
11. **Fully automatic models.** Measured models populate the stack by themselves and the manual model picker goes away. Waits on the consent question: a stack claiming a model the owner never approved. Fog on [map #292](https://github.com/alp82/aistack/issues/292).
12. **Parked bets.** Monetization, the consultant badge, stack categories, messaging, stack export. A map picks one up when demand shows.

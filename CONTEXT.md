...
machine and means send everything inside the send window. The send window (400 days)
bounds what the CLI ships and what the page reads; the server keeps every day it holds.

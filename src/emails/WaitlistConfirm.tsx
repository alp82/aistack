...
export function WaitlistConfirm(props: { productName: string; ctaUrl: string }) {
    ...
    <Html>
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.p}>
            Thanks for joining the {productName} waitlist. I'll email you when the first version is ready.
          </Text>

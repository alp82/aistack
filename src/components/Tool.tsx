...
export function Tool({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-all duration-200 cursor-pointer group" style={{ height: `${height}px` }}>
          ...
          <div className="text-sm">
            ...
            <ul className="space-y-1">
              {pros.slice(0, 4).map((pro, index) => (
                <li key={index} className="text-green-600 text-xs flex items-start">

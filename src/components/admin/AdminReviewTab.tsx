...
import { Check, X, Edit2, Flag, Package, Wrench, Brain, Pencil } from "lucide-react";
							...
							{flaggedStacks.map((stack) => (
								...
								>
									<div className="flex items-start justify-between gap-4">
										...
										<div className="flex items-center gap-2 shrink-0">
											<span className="border border-orange-400/50 bg-orange-400/10 px-2 py-1 font-mono text-xs font-bold text-orange-400">
												{stack.flagCount} {stack.flagCount === 1 ? "report" : "reports"}
											</span>
											<a
									...
									<div className="flex gap-3 mt-4 pt-4 border-t border-stroke-subtle">
										<button
											type="button"
											onClick={() => markStackLowQuality({ stackId: stack._id })}
							...
							{lowQualityStacks.map((stack) => (
								...
								>
									...
									<div className="flex gap-3 mt-4 pt-4 border-t border-stroke-subtle">
										<button
											type="button"
											onClick={() => unmarkStackLowQuality({ stackId: stack._id })}

					...
					<fieldset className="space-y-4">
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="space-y-2">
								<Label htmlFor="bundle-name" className="font-mono text-xs font-semibold uppercase tracking-wide text-fg-secondary">
									Bundle Name *
								</Label>
								<Input
									id="bundle-name"
							...
							<div className="space-y-2">
								<Label htmlFor="bundle-website" className="font-mono text-xs font-semibold uppercase tracking-wide text-fg-secondary">
									Website URL
								</Label>
								<Input
									id="bundle-website"
						...
						<div className="space-y-2">
							<Label htmlFor="bundle-icon" className="font-mono text-xs font-semibold uppercase tracking-wide text-fg-secondary">
								Icon URL
							</Label>

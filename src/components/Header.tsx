...
import { Edit, LogOut, Plus, Shield } from "lucide-react";
...
export default function Header() {
	...
	return (
		<header className="sticky top-0 z-50 h-14 border-b-2 border-stroke-strong bg-bg-canvas">
				...
				<div className="flex items-center gap-3">
					...
					{isAdmin && (
						<Link
							to="/admin/tools"
							className={cn(
								"hidden items-center gap-1 font-mono text-xs font-semibold uppercase tracking-[0.15em] transition-colors md:inline-flex",
								isActive("/admin") ? "text-accent-lime" : "text-fg-muted hover:text-fg-primary"
							)}
						>

...
export function AddMissingItemButton({
	...
	return (
		<button
			...
			className="group flex w-full items-center gap-3 border border-dashed border-stroke-subtle bg-fg-muted/5 px-3 py-2.5 text-left transition-all hover:border-accent-lime hover:bg-accent-lime/5"
		>

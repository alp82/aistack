...
The felt-reasons half of *why current users don't curate* (the analytics ticket
answered the "what"; this answers the "why"). Direct evidence for the keystone
identity decision ([#7](https://github.com/alp82/aistack/issues/7)) and the CLI
role decision ([#8](https://github.com/alp82/aistack/issues/8)).
...
**4. Two audiences, diverging on return-value — and passive discovery loses to the algorithm.**

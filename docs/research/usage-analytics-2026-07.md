...
1. **[medium] Top-of-funnel is alive.** Signups are steady: Jan 12, Mar 34, Apr 24, May 21, Jun 22, Jul 7 (half-month). People keep finding the site and going all the way to a published stack; the leak comes *after* publish.
